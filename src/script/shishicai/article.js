...
document.title = document.title.replace('重庆时时彩追冷回补技巧，让你不再吃亏',stit).replace('皇家彩世界', '新世界')
var keywords = $("meta[name=keywords]").attr("content");
var description = $("meta[name=description]").attr("content");
$("meta[name=keywords]").attr('content', keywords.replace('重庆时时彩追冷回补技巧，让你不再吃亏', stit).replace('皇家彩世界', '新世界'));
$("meta[name=description]").attr('content', description.replace('重庆时时彩追冷回补技巧，让你不再吃亏', stit).replace('皇家彩世界', '新世界'));
