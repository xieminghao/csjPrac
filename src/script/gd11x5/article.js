...
document.title = document.title.replace('广东11选5投注技巧特别篇(必读五)',stit).replace('皇家彩世界', '新世界')
var keywords = $("meta[name=keywords]").attr("content");
var description = $("meta[name=description]").attr("content");
$("meta[name=keywords]").attr('content', keywords.replace('广东11选5投注技巧特别篇(必读五)', stit).replace('皇家彩世界', '新世界'));
$("meta[name=description]").attr('content', description.replace('广东11选5投注技巧特别篇(必读五)', stit).replace('皇家彩世界', '新世界'));
