(function () {
    ...
    function afterAwarded() {
        ...
        if (_page) {
            ...
            setTimeout(function () {
                $.get('/pl3/' + _page, { t: Math.random() }, function (text) {
    ...
    var awardTick = function () {
        $.get('/pl3/ajax', { ajaxhandler: 'GetAwardData', t: Math.random() }, function (data) {
            requireCount += 1;
    ...
    function loadAwardTimes() {
        $.get('/pl3/ajax', { ajaxhandler: 'GetAwardTimes', t: Math.random() }, function (data) {
            //请求到数据后需要做的事情
            ...
            if (data.current.periodNumber != cpNumber) {
                ...
                countDownTimer = window.setInterval(function () {
                    ...
                    showCountDown(cpNextAwardTimeInterval, data.next.periodNumber, "pl3")
                }, 1000);
            }
...
function updateHistoryRecord() {
    $.get('/pl3/ajax', { ajaxhandler: 'GetNewestRecord', t: Math.random() }, function (data) {
