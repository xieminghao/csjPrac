$(function () {
    ...
    var cq_awardTick = function () {
        $.get('/shishicai/ajax?' + Math.random(), { ajaxhandler: 'GetCqsscAwardData' }, function (data) {
    ...
    var pk10_awardTick = function () {
        $.get('/pk10/ajax?' + Math.random(), { ajaxhandler: 'GetPk10AwardData' }, function (data) {
...
var drawTrend = function() {
    ...
    $.get("/pk10/numbertrendData", { ball: ball, count: 25, t: Math.random() }, function (result) {
