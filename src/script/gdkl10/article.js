...
document.title = document.title.replace('广东快乐十分四个特别技巧方法',stit).replace('皇家彩世界', '新世界')
var keywords = $("meta[name=keywords]").attr("content");
var description = $("meta[name=description]").attr("content");
$("meta[name=keywords]").attr('content', keywords.replace('广东快乐十分四个特别技巧方法', stit).replace('皇家彩世界', '新世界'));
$("meta[name=description]").attr('content', description.replace('广东快乐十分四个特别技巧方法', stit).replace('皇家彩世界', '新世界'));
